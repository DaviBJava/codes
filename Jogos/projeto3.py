...
# NOVO: Configurações dos Inimigos
inimigos = []
largura_inimigo = 40
altura_inimigo = 25
velocidade_inimigo_x = 2 # Velocidade horizontal inicial
descida_inimigo = 10     # O quanto eles descem ao tocar na borda

# NOVO: Criando a grade de inimigos
num_linhas = 5
num_colunas = 10
espacamento = 15 # Espaço entre os inimigos
...
while rodando:
    ...
    # NOVO: Lógica dos Inimigos
    # Movimenta todos os inimigos horizontalmente
    for inimigo in inimigos:
        inimigo.x += velocidade_inimigo_x

    # Verifica se o bloco de inimigos deve mudar de direção
    mudar_direcao = False
    for inimigo in inimigos:
